...
class CreateTblProgramTertentuDtsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_program_tertentu_dts', function (Blueprint $table) {
            $table->id();   
    ...
    {
        Schema::dropIfExists('tbl_program_tertentu_dts');
    }
}
