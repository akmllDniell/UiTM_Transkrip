      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <td>
              <form action="{{ route('jeniskebudayaan.destroy',$d->id) }}" method="post" onsubmit="return confirm('Are sure to delete?')">
                      @csrf
                      @method('delete')
                      <a href="{{ route('jeniskebudayaan.edit',$d->id) }}" class="btn btn-sm btn-warning">Edit</a>
