...
<form action="/jeniskebudayaan" method="post">
    ...
    <div class="form-group">
        ...
        <input style="text-transform: uppercase" type="text" name="jeniskebudayaan" value="{{old('jeniskebudayaan')}}" class="form-control @error('jeniskebudayaan') is-invalid  @enderror">
