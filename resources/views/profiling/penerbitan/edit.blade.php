                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="/penerbitan">PENERBITAN/MAJALAH</a></li>
                          <li class="breadcrumb-item active">Add PENERBITAN/MAJALAH</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
...
<form action="/penerbitan/{{$datas->id}}" method="post" >
  @csrf
  @method('PATCH') 
    <center>
