...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Data Program Tertentu</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item active">Program Tertentu</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="card">
          ...
          <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                Program Tertentu       
                <a href=" {{ route('jenisprogramtertentu.create') }}"><button type="submit" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus-circle"></i></button></a>
              <tr>
                <th>Jenis Program Tertentu</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
            ...
            <td>
              <form action="{{ route('jenisprogramtertentu.destroy',$d->id) }}" method="post" onsubmit="return confirm('Are sure to delete?')">
                      @csrf
                      @method('delete')
                      <a href="{{ route('jenisprogramtertentu.edit',$d->id) }}" class="btn btn-sm btn-warning">Edit</a>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-header d-flex justify-content-between align-items-center">Program tertentu
              <a href=" {{ route('programtertentu.create') }}"><button type="submit" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus-circle"></i></button></a>
            </h4>
            <br>
