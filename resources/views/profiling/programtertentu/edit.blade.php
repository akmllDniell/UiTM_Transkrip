        ...
        <div class="col-12">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Add PROGRAM TERTENTU</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="/programtertentu">PROGRAM TERTENTU</a></li>
                          <li class="breadcrumb-item active">Add PROGRAM TERTENTU</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
...
<form action="/programtertentu/{{$datas->id}}" method="post" >
  @csrf
  @method('PATCH') 
    <center>
    <div class="form-group" style="width:50%; float: left; padding: 20px; margin-top:5%" >
       
        <label>PILIH PORGRAM TERTENTU ANDA</label>
