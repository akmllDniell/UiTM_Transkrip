...
<div class="card">
    <div class="card-body">
<form action="/jenissijil/{{$datas->id}}" 
    method="post" >    
    @csrf
    @method('PATCH') 
    <div class="form-group">
        <label >Jenis Anugerah/Sijil/Pingat</label>
        <input style="text-transform: uppercase" type="text" name="jenissijil" value="{{$datas->sijil}}" class="form-control @error('jenissijil') is-invalid  @enderror">
        @error('jenissijil')
