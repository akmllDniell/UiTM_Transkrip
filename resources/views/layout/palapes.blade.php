...
<div class="wrapper">
  ...
  <div class="form-container">
    ...
    <form method="POST" action="{{url('/SimpanJawatanpalapes')}}" >
            @csrf
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title"> palapes</h3>
            </div>          
              <!-- Color Picker -->
              <div class="form-group">
                <label>Jawatan palapes:</label>
                <input name="jenisjawatanpalapes" id="jenisjawatanpalapes" type="text" class="form-control my-colorpicker1 colorpicker-element" data-colorpicker-id="1" data-original-title="" title="">
              </div>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              @foreach($jawatanpalapes as $d)
            <tr>
            <td>{{$d->jawatanpalapes}}</td>
      @endforeach
        ...
        <!-- /.card-body -->
            ...
            <!-- /.card -->
            <form method="POST" action="{{url('/Simpanpalapes')}}" >
                @csrf
                <div class="card card-info">
                  <div class="card-header">
                    <h3 class="card-title">TAHAP PENCAPAIAN DAN MARKAH palapes</h3>
                  </div>
                  <div class="card-body">
                    <!-- Color Picker -->
                    <div class="form-group">
                      <label>Tahap dan Markah palapes:</label>
                      <select id="jwtpalapes" name="jwtpalapes">
                        @foreach($jawatanpalapes as $d)
                                <option value="{{$d->jawatanpalapesid}}">{{$d->jawatanpalapes}}</option>            
                          @endforeach
                      ...
                      <select id="Markahpalapes" name="Markahpalapes">
                        @foreach($markah as $d)
