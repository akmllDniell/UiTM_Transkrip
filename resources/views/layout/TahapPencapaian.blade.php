      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <!-- /.card -->
            <form method="POST" action="{{url('/SimpanTahapPencapaian')}}" >
                @csrf
                @if ($errors->any())
        ...
        @endif
              <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">TAHAP</h3>
                      </div>
                      <div class="card-body">
                        <!-- Color Picker -->                
                        <div class="form-group">
                            <label>Tahap pencapaian:</label>
                            <input name="namatahap" id="namatahap" type="text" class="form-control my-colorpicker1 colorpicker-element" data-colorpicker-id="1" data-original-title="" title="">
                          </div>
                        <!-- /.form group -->
