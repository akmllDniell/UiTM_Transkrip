...
class TblPaduDtController extends Controller
{
    ...
    public function index()
    {
        $data = DB::table('tbl_padu_dts')   
         ->join('tbl_profil_tahap_heps', 'tbl_padu_dts.idTH', '=', 'tbl_profil_tahap_heps.id') 
         ->join('tbl_profil_markahs', 'tbl_padu_dts.idmarkah', '=', 'tbl_profil_markahs.id') 
         ->select('tbl_padu_dts.*','tbl_profil_tahap_heps.*','tbl_profil_markahs.*','tbl_padu_dts.id as padudtid','tbl_profil_markahs.id as markahid','tbl_profil_tahap_heps.id as thid')
         ->get();

        $padu = TblPadu::all();
        $markah = TblProfilMarkah::all();
        $tahaphep = TblProfilTahapHep::all();
    ...
    public function create()
    {
        ...
        return view('profiling.padu.create',compact('markah'),compact('tahaphep'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            //validation messages
            [
                'TH.required' => 'SIla pilih Tahap Hep anda',
                'markah.required' => 'Sila pilih markah anda'
            ]
            );

            TblPaduDt::create([
                'idTH' => $request->input('TH'),
    ...
    public function edit($id)
    {
        ...
        //  ->join('tbl_profil_tahap_heps', 'tbl_sukans.idTH', '=', 'tbl_profil_tahap_heps.id') 
        //  ->join('tbl_profil_markahs', 'tbl_sukans.idmarkah', '=', 'tbl_profil_markahs.id') 
        //  ->select('tbl_sukans.*','tbl_profil_tahap_heps.*','tbl_profil_markahs.*','tbl_sukans.id as sukanid','tbl_profil_markahs.id as markahid','tbl_profil_tahap_heps.id as thid')
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'idTH.required' => 'Sila pilih Tahap pencapaian',
            ]
        );

        TblPaduDt::find($id)->update([
            'idmarkah' => $request->input('idmarkah'),
            'idTH' => $request->input('idTH'),
        ]);
